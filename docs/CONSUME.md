...
Published crates.io is `0.9.2`. <!-- x-release-please-version -->
Current tag is `v0.9.2`. <!-- x-release-please-version -->
...
published tag `v0.9.2` until the next cut: <!-- x-release-please-version -->

```toml
[dependencies]
wiremux-auth = "0.9.2" # x-release-please-version
wiremux = { version = "0.9.2", default-features = false } # x-release-please-version
```
...
Published hosts pin crates.io `0.9.2`. <!-- x-release-please-version -->
Matching tag is `v0.9.2`. <!-- x-release-please-version -->
Published hosts stay on `0.9.2` until they choose a later crates.io cut. <!-- x-release-please-version -->
